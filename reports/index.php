    ...
    try {
        ...
        if ($stmt->rowCount() > 0) {
            ...
            while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                $formatted_prod_price = number_format((float)$row['prod_price'], 2, '.', '');
            ...
            <div class="modal-body">
                <form id="addTransaction_form" method="post" role="form" autocomplete="off">
                    <div class="form-group">
                        <div class="row">
                            <div class="col">
                                <label for="select_add_product">Report</label>
                                <select id="select_add_product" class="form-control" name="select_add_product">
                                    <?php echo fetchSelectProduct(); ?>
                                </select>
                                <input hidden type="text" id="add_prod_id" name="add_prod_id" class="form-control" autocomplete="off" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="number" class="form-control" id="add_tr_qty" name="add_tr_qty" value=0 min=0 required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                                <label for="add_tr_date">Report Date</label>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input disabled id="disabled_st_id" class="form-control" value="<?php echo $_SESSION['username']; ?>">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <input hidden type="text" id="edit_prod_id" name="edit_prod_id" class="form-control" autocomplete="off" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <input type="number" class="form-control" id="edit_tr_qty" name="edit_tr_qty" value=0 min=0 required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                    <label for="edit_tr_date">Report Date</label>
                                    <input type="datetime-local" class="form-control" id="edit_tr_date" name="edit_tr_date" required>
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <input disabled id="disabled_edit_st_id" class="form-control" value="<?php echo $_SESSION['username']; ?>">
